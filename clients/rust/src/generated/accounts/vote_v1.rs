...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountDeserialize for VoteV1 {
...
#[cfg(feature = "anchor")]
impl anchor_lang::AccountSerialize for VoteV1 {}

#[cfg(feature = "anchor")]
impl anchor_lang::Owner for VoteV1 {
    fn owner() -> Pubkey {
        crate::OPTIMISTIC_ORACLE_ID
    }
}
...
impl anchor_lang::IdlBuild for VoteV1 {}

#[cfg(feature = "anchor-idl-build")]
impl anchor_lang::Discriminator for VoteV1 {

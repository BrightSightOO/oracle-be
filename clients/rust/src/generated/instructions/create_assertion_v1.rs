...
impl CreateAssertionV1 {
    pub fn instruction(
        &self,
        args: CreateAssertionV1InstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateAssertionV1InstructionData::new().try_to_vec().unwrap();
...
pub struct CreateAssertionV1InstructionData {
    discriminator: u8,
}

impl CreateAssertionV1InstructionData {
    pub fn new() -> Self {
        Self { discriminator: 7 }
    }
}

impl Default for CreateAssertionV1InstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct CreateAssertionV1InstructionArgs {
    pub value: u64,
}

/// Instruction builder for `CreateAssertionV1`.
///
/// ### Accounts:
///
///   0. `[]` config
...
pub struct CreateAssertionV1Builder {
...
impl CreateAssertionV1Builder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CreateAssertionV1 {
        ...
        let args = CreateAssertionV1InstructionArgs {
...
/// `create_assertion_v1` CPI accounts.
pub struct CreateAssertionV1CpiAccounts<'a, 'b> {
    /// Config
...
/// `create_assertion_v1` CPI instruction.
pub struct CreateAssertionV1Cpi<'a, 'b> {
    ...
    pub __args: CreateAssertionV1InstructionArgs,
}

impl<'a, 'b> CreateAssertionV1Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CreateAssertionV1CpiAccounts<'a, 'b>,
        args: CreateAssertionV1InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateAssertionV1` via CPI.
///
/// ### Accounts:
///
///   0. `[]` config
...
///   9. `[]` system_program
#[derive(Clone, Debug)]
pub struct CreateAssertionV1CpiBuilder<'a, 'b> {
    instruction: Box<CreateAssertionV1CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateAssertionV1CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateAssertionV1CpiBuilderInstruction {
            __program: program,
            config: None,
            request: None,
            assertion: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateAssertionV1Cpi {
...
#[derive(Clone, Debug)]
struct CreateAssertionV1CpiBuilderInstruction<'a, 'b> {

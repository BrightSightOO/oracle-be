...
// Accounts.
export interface CreateAssertionV1InstructionAccounts {
  /** Config */
...
// Data.
export interface CreateAssertionV1InstructionData {
  discriminator: number;
  value: bigint;
}

export interface CreateAssertionV1InstructionDataArgs {
  value: number | bigint;
}

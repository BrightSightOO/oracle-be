...
import type { AccountMeta, Pda, PublicKey, Signer } from "@metaplex-foundation/umi";

import { isPda, isSigner, publicKey } from "@metaplex-foundation/umi";
 ...
 * @internal
 */
export function expectPublicKey(value: PublicKey | Pda | Signer | null | undefined): PublicKey {
  if (!value) {
 ...
 * @internal
 */
export function expectPda(value: PublicKey | Pda | Signer | null | undefined): Pda {
 ...
 * @internal
 */
export interface ResolvedAccount<T = PublicKey | Pda | Signer | null> {
  isWritable: boolean;
  value: T;
}
...
export function getAccountMetasAndSigners(
  accounts: Array<ResolvedAccount>,
  optionalAccountStrategy: "omitted" | "programId",
  programId: PublicKey,
): [Array<AccountMeta>, Array<Signer>] {
